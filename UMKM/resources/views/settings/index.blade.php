            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <section class="bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-xl shadow-emerald-900/5 border border-stone-100/85 dark:border-zinc-800/85">
                    <div class="flex items-center justify-between border-b border-stone-100 dark:border-zinc-800/60 pb-4 mb-6">
                        ...
                        <span class="text-[10px] uppercase font-bold text-stone-400 dark:text-zinc-400 tracking-wider">Konfigurasi Toko</span>
                    </div>
                    ...
                    <form action="{{ route('settings.company') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <!-- Logo Upload Section -->
                        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-5 p-4 rounded-2xl bg-stone-50 dark:bg-zinc-850 dark:bg-zinc-800 border border-stone-200/50 dark:border-zinc-850">
                            <div class="shrink-0">
                                @if($company->logo)
                                ...
                                @else
                                    <div class="w-20 h-20 rounded-2xl bg-stone-200 dark:bg-zinc-800 flex items-center justify-center text-stone-400 dark:text-zinc-400">
                                        <span class="material-symbols-outlined text-3xl">image</span>
                                    </div>
                                @endif
                            </div>
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-stone-700 dark:text-zinc-50 dark:text-zinc-200">Logo Toko / PDF Header</label>
                                <input type="file" name="logo" class="block w-full text-xs text-stone-500 dark:text-white file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-[#0b6e4f]/10 file:text-[#0b6e4f] dark:file:text-zinc-400 hover:file:bg-[#0b6e4f]/20 file:cursor-pointer">
                                <p class="text-[10px] text-stone-400 dark:text-zinc-400">Format JPEG, PNG, JPG atau WebP (Maks. 2MB). Logo ini akan ditampilkan di header Laporan PDF.</p>
                            </div>
                        </div>

                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-stone-600 dark:text-zinc-300 uppercase tracking-wider">Nama UMKM</label>
                            ...
                            <div class="space-y-2">
                                <label class="text-xs font-bold text-stone-600 dark:text-zinc-300 uppercase tracking-wider">Nomor Telepon</label>
                                <input class="w-full bg-stone-50 dark:bg-zinc-850 dark:bg-zinc-800 border border-stone-200/60 dark:border-zinc-800/80 rounded-2xl px-4 py-3 text-sm focus:ring-4 focus:ring-[#0b6e4f]/5 dark:focus:ring-emerald-500/10 focus:border-[#0b6e4f] dark:focus:border-emerald-500 outline-none transition-all duration-200 text-stone-800 dark:text-white font-medium" 
                ...
                <section class="bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-xl shadow-emerald-900/5 border border-stone-100/85 dark:border-zinc-800/85">
                    <div class="flex items-center justify-between border-b border-stone-100 dark:border-zinc-800/60 pb-4 mb-6">
                        ...
                        <span class="text-[10px] uppercase font-bold text-stone-400 dark:text-zinc-400 tracking-wider">Printer</span>
                    </div>
                    ...
                    <form action="{{ route('settings.printer') }}" method="POST" class="space-y-5">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <span class="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-stone-400 dark:text-zinc-400 pointer-events-none">unfold_more</span>
                            </div>
                            <p class="text-[10.5px] text-stone-400 dark:text-zinc-400 leading-normal">Pilih lebar kertas yang digunakan oleh printer thermal Anda. Ini akan secara otomatis menyesuaikan format cetakan struk belanja transaksi POS agar tidak terpotong.</p>
                        </div>
            ...
            <div class="space-y-8">
                ...
                <section class="bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-xl shadow-emerald-900/5 border border-stone-100/85 dark:border-zinc-800/85">
                    ...
                    <form action="{{ route('settings.password') }}" method="POST" class="space-y-4">
                        ...
                        <div class="space-y-1.5">
                            <label class="text-[10px] font-bold text-stone-600 dark:text-zinc-300 uppercase tracking-wider">Kata Sandi Saat Ini</label>
                            <input class="w-full bg-stone-50 dark:bg-zinc-850 dark:bg-zinc-800 border border-stone-200/60 dark:border-zinc-800/80 rounded-2xl px-4 py-2.5 text-xs focus:ring-4 focus:ring-[#0b6e4f]/5 dark:focus:ring-emerald-500/10 focus:border-[#0b6e4f] dark:focus:border-emerald-500 outline-none transition-all duration-200" 
                                   name="current_password" required type="password"/>
                        </div>

                        <div class="space-y-1.5">
                            <label class="text-[10px] font-bold text-stone-600 dark:text-zinc-300 uppercase tracking-wider">Kata Sandi Baru</label>
                            <input class="w-full bg-stone-50 dark:bg-zinc-850 dark:bg-zinc-800 border border-stone-200/60 dark:border-zinc-800/80 rounded-2xl px-4 py-2.5 text-xs focus:ring-4 focus:ring-[#0b6e4f]/5 dark:focus:ring-emerald-500/10 focus:border-[#0b6e4f] dark:focus:border-emerald-500 outline-none transition-all duration-200" 
                                   name="password" required type="password"/>
                        </div>

                        <div class="space-y-1.5">
                            <label class="text-[10px] font-bold text-stone-600 dark:text-zinc-300 uppercase tracking-wider">Konfirmasi Kata Sandi Baru</label>
                            <input class="w-full bg-stone-50 dark:bg-zinc-850 dark:bg-zinc-800 border border-stone-200/60 dark:border-zinc-800/80 rounded-2xl px-4 py-2.5 text-xs focus:ring-4 focus:ring-[#0b6e4f]/5 dark:focus:ring-emerald-500/10 focus:border-[#0b6e4f] dark:focus:border-emerald-500 outline-none transition-all duration-200" 
                ...
                <section class="bg-white dark:bg-zinc-900 rounded-3xl p-6 shadow-xl shadow-emerald-900/5 border border-stone-100/85 dark:border-zinc-800/85">
                    ...
                    <div class="space-y-4">
                        ...
                        <div x-data="{ open: false }" class="p-3.5 rounded-2xl bg-stone-50 dark:bg-zinc-850 dark:bg-zinc-800 border border-stone-200/40 dark:border-zinc-800/40 space-y-3">
                                ...
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        <p class="text-xs font-bold text-stone-800 dark:text-white flex items-center gap-1">
                                            {{ $u->name }}
                                            @if($u->id === auth()->id())
                                                <span class="text-[9px] px-1.5 py-0.2 bg-stone-200 dark:bg-zinc-800 text-stone-600 dark:text-zinc-300 rounded">Anda</span>
                                            @endif
                                        </p>
                                        <p class="text-[9px] text-stone-400 dark:text-zinc-400 uppercase font-bold tracking-wider leading-none">{{ $u->role }} &bull; {{ $u->email }}</p>
                                    </div>
                                </div>
                                @if($u->id !== auth()->id())
                                <button @click="open = !open" 
                                        type="button" 
                                        class="px-2.5 py-1 rounded-lg border border-stone-200 dark:border-zinc-800 text-[10px] font-bold text-stone-700 dark:text-zinc-50 dark:text-zinc-200 bg-white dark:bg-zinc-900 hover:bg-stone-50 dark:hover:bg-zinc-850 dark:hover:bg-zinc-800 dark:hover:bg-zinc-800/60 shadow-sm active:scale-95 transition-all flex items-center gap-1">
                            ...
                            <div x-show="open" x-collapse style="display: none;" class="pt-3.5 border-t border-stone-200/40 dark:border-zinc-800/40">
                                <form action="{{ route('settings.password') }}" method="POST" class="space-y-3">
                                    ...
                                    <div class="space-y-2">
                                        <div class="space-y-1">
                                            <label class="text-[9px] font-bold text-stone-500 dark:text-zinc-400 uppercase tracking-wider">Sandi Baru</label>
                                        ...
                                        <div class="space-y-1">
                                            <label class="text-[9px] font-bold text-stone-500 dark:text-zinc-400 uppercase tracking-wider">Konfirmasi Sandi Baru</label>
                                    ...
                                    <div class="flex justify-end gap-2 pt-1">
                                        <button @click="open = false" type="button" class="px-2.5 py-1 rounded-lg text-[10px] font-semibold text-stone-500 dark:text-zinc-400 hover:bg-stone-100 dark:hover:bg-zinc-800 dark:hover:bg-zinc-800/80">Batal</button>
